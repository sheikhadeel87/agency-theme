...
export function DefaultPrivacyPolicyContent() {
  return (
    <div className="mt-10 space-y-8 leading-relaxed text-gray-700">
      ...
      <section>
        <h2 className="text-xl font-semibold text-[#0f172a]">4. Cookies and Tracking Technologies</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-xl font-semibold text-[#0f172a]">5. Data Security</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-xl font-semibold text-[#0f172a]">6. Third-Party Services</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-xl font-semibold text-[#0f172a]">7. Your Rights</h2>
        <p className="mt-3">
